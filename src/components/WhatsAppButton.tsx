...
export function WhatsAppButton() {
    return (
        <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="fixed bottom-6 right-6 bg-green-500 text-white w-14 h-14 rounded-full flex justify-center items-center shadow-lg hover:bg-green-600 transition-all duration-300 ease-out group z-50 relative"
        ...
        >
            ...
            {/* WhatsApp Icon */}
            <svg viewBox="0 0 16 16" className="w-7 h-7 relative z-10" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
